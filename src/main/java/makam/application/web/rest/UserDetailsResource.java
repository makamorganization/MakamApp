...
/**
 * REST controller for managing {@link makam.application.domain.UserDetails}.
 */
@RestController
@RequestMapping("/api")
public class UserDetailsResource {
    ...
    public List<UserDetailsDTO> getAllUserDetails(@RequestParam(required = false) String filter,@RequestParam(required = false, defaultValue = "false") boolean eagerload) {
