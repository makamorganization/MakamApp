...
/**
 * Integration tests for the {@Link CourseParticipantResource} REST controller.
 */
@SpringBootTest(classes = MakamApp.class)
public class CourseParticipantResourceIT {
     ...
     * if they test an entity which requires the current entity.
     */
    public static CourseParticipant createUpdatedEntity(EntityManager em) {
        CourseParticipant courseParticipant = new CourseParticipant()
    ...
    public void createCourseParticipant() throws Exception {
        ...
        CourseParticipantDTO courseParticipantDTO = courseParticipantMapper.toDto(courseParticipant);
        restCourseParticipantMockMvc.perform(post("/api/course-participants")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(courseParticipantDTO)))
    ...
    public void updateCourseParticipant() throws Exception {
        ...
        updatedCourseParticipant
            ...
            .isUserLate(UPDATED_IS_USER_LATE)
            .canCancelCourseAttendance(UPDATED_CAN_CANCEL_COURSE_ATTENDANCE);
        CourseParticipantDTO courseParticipantDTO = courseParticipantMapper.toDto(updatedCourseParticipant);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(CourseParticipantDTO.class);
        CourseParticipantDTO courseParticipantDTO1 = new CourseParticipantDTO();
        courseParticipantDTO1.setId(1L);
        CourseParticipantDTO courseParticipantDTO2 = new CourseParticipantDTO();
        assertThat(courseParticipantDTO1).isNotEqualTo(courseParticipantDTO2);
        courseParticipantDTO2.setId(courseParticipantDTO1.getId());
        assertThat(courseParticipantDTO1).isEqualTo(courseParticipantDTO2);
        courseParticipantDTO2.setId(2L);
        assertThat(courseParticipantDTO1).isNotEqualTo(courseParticipantDTO2);
        courseParticipantDTO1.setId(null);
        assertThat(courseParticipantDTO1).isNotEqualTo(courseParticipantDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(courseParticipantMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(courseParticipantMapper.fromId(null)).isNull();
    }
}
