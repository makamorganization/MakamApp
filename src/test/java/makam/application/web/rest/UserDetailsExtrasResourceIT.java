...
/**
 * Integration tests for the {@Link UserDetailsExtrasResource} REST controller.
 */
@SpringBootTest(classes = MakamApp.class)
public class UserDetailsExtrasResourceIT {
    ...
    @Autowired
    private UserDetailsExtrasMapper userDetailsExtrasMapper;
     ...
     * if they test an entity which requires the current entity.
     */
    public static UserDetailsExtras createUpdatedEntity(EntityManager em) {
        UserDetailsExtras userDetailsExtras = new UserDetailsExtras()
    ...
    public void createUserDetailsExtras() throws Exception {
        ...
        UserDetailsExtrasDTO userDetailsExtrasDTO = userDetailsExtrasMapper.toDto(userDetailsExtras);
        restUserDetailsExtrasMockMvc.perform(post("/api/user-details-extras")
            .contentType(TestUtil.APPLICATION_JSON_UTF8)
            .content(TestUtil.convertObjectToJsonBytes(userDetailsExtrasDTO)))
    ...
    public void updateUserDetailsExtras() throws Exception {
        ...
        updatedUserDetailsExtras
            ...
            .numberOfCoursesTotalOmited(UPDATED_NUMBER_OF_COURSES_TOTAL_OMITED)
            .numberOfCoursesOmitedInRow(UPDATED_NUMBER_OF_COURSES_OMITED_IN_ROW);
        UserDetailsExtrasDTO userDetailsExtrasDTO = userDetailsExtrasMapper.toDto(updatedUserDetailsExtras);
    ...
    public void dtoEqualsVerifier() throws Exception {
        TestUtil.equalsVerifier(UserDetailsExtrasDTO.class);
        UserDetailsExtrasDTO userDetailsExtrasDTO1 = new UserDetailsExtrasDTO();
        userDetailsExtrasDTO1.setId(1L);
        UserDetailsExtrasDTO userDetailsExtrasDTO2 = new UserDetailsExtrasDTO();
        assertThat(userDetailsExtrasDTO1).isNotEqualTo(userDetailsExtrasDTO2);
        userDetailsExtrasDTO2.setId(userDetailsExtrasDTO1.getId());
        assertThat(userDetailsExtrasDTO1).isEqualTo(userDetailsExtrasDTO2);
        userDetailsExtrasDTO2.setId(2L);
        assertThat(userDetailsExtrasDTO1).isNotEqualTo(userDetailsExtrasDTO2);
        userDetailsExtrasDTO1.setId(null);
        assertThat(userDetailsExtrasDTO1).isNotEqualTo(userDetailsExtrasDTO2);
    }
    ...
    public void testEntityFromId() {
        assertThat(userDetailsExtrasMapper.fromId(42L).getId()).isEqualTo(42);
        assertThat(userDetailsExtrasMapper.fromId(null)).isNull();
    }
}
