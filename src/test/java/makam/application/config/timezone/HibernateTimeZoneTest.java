package makam.application.config.timezone;

import makam.application.MakamApp;
import makam.application.repository.timezone.DateTimeWrapper;
import makam.application.repository.timezone.DateTimeWrapperRepository;
